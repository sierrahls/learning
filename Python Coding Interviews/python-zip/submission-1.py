...
"""We create an empty dict to start assigning the names and scores to.
We iterate through both lists with zip()
and then take the indexes and assign them to our group"""
